  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="w-full text-left text-xs space-y-3 mt-6 pt-6 border-t border-slate-100 dark:border-slate-750 text-slate-600 dark:text-slate-350">
            ...
            {user?.address && (
              <div className="flex items-start gap-2">
                ...
                <span className="leading-relaxed">{user.address} (Zip: {user.zip})</span>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="md:col-span-2 bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-205 dark:border-slate-750 shadow-card space-y-4">
          <h3 className="text-sm font-bold text-slate-855 dark:text-slate-200 flex items-center gap-2 border-b pb-3">
