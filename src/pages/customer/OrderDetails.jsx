...
const OrderDetails = () => {
  ...
  const fetchOrderDetails = async () => {
    try {
      ...
      toast.error('Order not found in telemetry registries.');
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-205 dark:border-slate-750 shadow-card">
            ...
            <div className="grid grid-cols-2 gap-4 mt-6 pt-6 border-t border-slate-100 dark:border-slate-750 text-xs">
              <div className="flex items-center gap-2 text-slate-600 dark:text-slate-350">
                <FiCalendar className="text-slate-400" />
                <div>
                  <p className="text-[10px] text-slate-405 font-bold">Booked Date</p>
              ...
              <div className="flex items-center gap-2 text-slate-600 dark:text-slate-350">
                ...
                <div>
                  <p className="text-[10px] text-slate-405 font-bold">Estimated Delivery</p>
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-205 dark:border-slate-750 shadow-card space-y-5">
            ...
            <div className="relative pl-6 space-y-6">
              ...
              <div className="absolute left-2.5 top-2.5 bottom-2.5 w-0.5 border-l border-dashed border-slate-300 dark:border-slate-700" />
              ...
              <div className="relative flex gap-3 items-start text-xs">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 dark:text-slate-100">Pickup Address</h4>
                  <p className="text-slate-500 dark:text-slate-400 mt-1">{order.pickupAddress}</p>
              ...
              <div className="relative flex gap-3 items-start text-xs">
                ...
                <div>
                  <h4 className="font-bold text-slate-900 dark:text-slate-100">Drop Address</h4>
                  <p className="text-slate-500 dark:text-slate-400 mt-1">{order.dropAddress}</p>
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-205 dark:border-slate-750 shadow-card space-y-5">
            ...
            <div className="grid grid-cols-3 gap-4 text-center">
              <div className="p-3 bg-slate-50 dark:bg-slate-750 rounded-lg">
                <p className="text-[10px] text-slate-405 font-bold uppercase">Volume L×B×H</p>
              ...
              <div className="p-3 bg-slate-50 dark:bg-slate-750 rounded-lg">
                <p className="text-[10px] text-slate-405 font-bold uppercase">Volumetric Weight</p>
                <p className="text-sm font-bold text-slate-800 dark:text-white mt-1">
                  {order.volumetricWeight} <span className="text-xxs font-normal">kg</span>
                </p>
              </div>
              <div className="p-3 bg-slate-50 dark:bg-slate-750 rounded-lg">
                <p className="text-[10px] text-slate-405 font-bold uppercase">Billable Weight</p>
                <p className="text-sm font-bold text-brand-605 dark:text-brand-400 mt-1">
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-205 dark:border-slate-750 shadow-card space-y-4">
            ...
            <div className="space-y-2.5 text-xs">
              <div className="flex justify-between">
                ...
                <span className="font-semibold text-slate-805 dark:text-slate-200">{formatCurrency(order.price * 0.85)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-500">Fuel & Zone Scope:</span>
                <span className="font-semibold text-slate-805 dark:text-slate-200">{formatCurrency(order.price * 0.15)}</span>
              </div>
              ...
              <div className="flex justify-between text-sm font-bold pt-1">
                ...
                <span className="text-brand-655 dark:text-brand-400">{formatCurrency(order.price)}</span>
              </div>
            </div>

            <div className="mt-4 pt-3.5 border-t border-slate-100 dark:border-slate-750 text-xxs font-medium text-slate-450">
              Payment mode: <span className="font-bold text-slate-700 dark:text-slate-300">{order.paymentType}</span>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-205 dark:border-slate-750 shadow-card space-y-4">
            ...
            {order.assignedAgentId ? (
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-[10px] text-slate-500 dark:text-slate-400">Electric Dispatch Rider</p>
                <div className="w-full flex items-center justify-between border-t border-slate-100 dark:border-slate-750 mt-4 pt-4 text-xxs text-slate-500">
                  <span>Tel: +1 (555) 012-3456</span>
                  <span className="font-mono">DL-98214-A</span>
                </div>
              </div>
            ) : (
              <div className="py-6 text-center text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                <FiPackage className="h-8 w-8 mx-auto text-slate-350 dark:text-slate-600 mb-2" />
      ...
      <Modal isOpen={showInvoiceModal} onClose={() => setShowInvoiceModal(false)} title="Simulated Invoice PDF" size="md">
        <div className="space-y-6 text-slate-800 dark:text-slate-200 p-2" id="printable-invoice">
          <div className="flex justify-between items-start border-b pb-4">
            <div>
              <h2 className="text-xl font-bold tracking-tight text-brand-600 dark:text-brand-400">SwiftRoute Invoice</h2>
              <p className="text-xxs text-slate-500 mt-1">SwiftRoute Logistics Inc, Terminal 4B</p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4 text-xxs">
            <div>
              ...
              <p className="font-bold text-slate-800 dark:text-slate-100 mt-1">{order.customerName}</p>
          ...
          <table className="w-full text-xxs border-collapse border border-slate-200">
            <thead>
              <tr className="bg-slate-100 dark:bg-slate-805 text-left">
            ...
            <tbody>
              ...
              <tr className="font-bold">
                ...
                <td className="p-2 border text-right text-brand-600 dark:text-brand-400">{formatCurrency(order.price)}</td>
              </tr>
            </tbody>
          </table>

          <div className="text-center text-[10px] text-slate-450 border-t pt-4">
            Thank you for shipping with SwiftRoute!
          </div>
